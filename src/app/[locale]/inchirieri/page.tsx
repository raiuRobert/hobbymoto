        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {rentalBikes.map((bike, i) => (
              <motion.div key={bike.id} {...fadeUp(i * 0.1)}
                ...
                <div className="relative h-56 bg-zinc-800 overflow-hidden">
                  ...
                  <div className="absolute top-3 left-3 px-2.5 py-1 bg-green-600 text-white text-[10px] font-black uppercase rounded-sm tracking-widest">
                    Disponibil
                  </div>
                </div>
                <div className="p-6">
